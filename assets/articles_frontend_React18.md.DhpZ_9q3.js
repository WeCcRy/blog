import{_ as t,C as e,c as i,o as l,ae as a,j as c,a as n,G as o}from"./chunks/framework.z0sZ1NT9.js";const h="/blog/assets/react-redux.CbOKGAZi.png",m=JSON.parse('{"title":"React18","description":"","frontmatter":{},"headers":[],"relativePath":"articles/frontend/React18.md","filePath":"articles/frontend/React18.md"}'),r={name:"articles/frontend/React18.md"};function d(k,s,g,u,E,y){const p=e("Outlet");return l(),i("div",null,[s[2]||(s[2]=a(`<h1 id="react18" tabindex="-1">React18 <a class="header-anchor" href="#react18" aria-label="Permalink to &quot;React18&quot;">​</a></h1><h2 id="函数式编程和组件式编程的区别" tabindex="-1">函数式编程和组件式编程的区别 <a class="header-anchor" href="#函数式编程和组件式编程的区别" aria-label="Permalink to &quot;函数式编程和组件式编程的区别&quot;">​</a></h2><p>在 React 语境下，这通常探讨的是 <strong>函数组件（Functional Components）</strong> 与 <strong>类组件（Class Components）</strong> 的区别。这两种不同的组件写法分别代表了不同的编程范式。</p><h3 id="_1-核心概念对比" tabindex="-1">1. 核心概念对比 <a class="header-anchor" href="#_1-核心概念对比" aria-label="Permalink to &quot;1. 核心概念对比&quot;">​</a></h3><ul><li><strong>类组件（Class Components）</strong>：属于<strong>面向对象编程（OOP）</strong>。它关注的是组件实例和生命周期。组件有自己的内部状态（<code>this.state</code>），并通过 <code>this</code> 来访问数据。需要通过生命周期钩子（如 <code>componentDidMount</code>、<code>componentDidUpdate</code>）来管理不同的阶段逻辑。</li><li><strong>函数组件（Functional Components）</strong>：属于<strong>函数式编程（FP）</strong>。核心思想是<strong>确定的输入决定确定的输出</strong>（<code>UI = f(state)</code>）。它更加关注数据的转化和渲染本身，不关心实例化，利用闭包（Closure）来捕获每一次渲染的独立状态。（即每一次的渲染都是基于当时的状态，类组件中渲染依赖state，但state是可变的）</li></ul><h3 id="_2-状态与副作用管理" tabindex="-1">2. 状态与副作用管理 <a class="header-anchor" href="#_2-状态与副作用管理" aria-label="Permalink to &quot;2. 状态与副作用管理&quot;">​</a></h3><ul><li><strong>类组件</strong>：往往通过生命周期将所有逻辑混杂在一起。比如在 <code>componentDidMount</code> 里同时发起不同的网络请求、绑定各类事件监听，然后再在 <code>componentWillUnmount</code> 里解绑事件。</li><li><strong>函数组件</strong>：凭借 React Hooks（如 <code>useState</code>、<code>useEffect</code>），可以按具体的业务功能将相关的副作用代码聚合在一起（例如订阅与清理写在同一个 <code>useEffect</code> 内），而不是根据生命周期硬性拆分。</li></ul><table tabindex="0"><thead><tr><th>class 组件</th><th>Hooks 组件</th></tr></thead><tbody><tr><td>constructor</td><td>useState</td></tr><tr><td>getDerivedStateFromProps</td><td>useState 里面 setxx 函数</td></tr><tr><td>shouldComponentUpdate</td><td>useMemo</td></tr><tr><td>render</td><td>函数本身（执行函数）</td></tr><tr><td>componentDidMount</td><td>useEffect</td></tr><tr><td>componentDidUpdate</td><td>useEffect</td></tr><tr><td>componentWillUnmount</td><td>useEffect 里面返回的函数</td></tr><tr><td>componentDidCatch</td><td>无</td></tr><tr><td>getDerivedStateFromError</td><td>无</td></tr></tbody></table><h1 id="jsx" tabindex="-1">JSX <a class="header-anchor" href="#jsx" aria-label="Permalink to &quot;JSX&quot;">​</a></h1><h2 id="响应表达式" tabindex="-1">响应表达式 <a class="header-anchor" href="#响应表达式" aria-label="Permalink to &quot;响应表达式&quot;">​</a></h2><p>通过 <code>{}</code> 识别表达式，类似vue中的双<code>{}</code></p><h2 id="列表渲染" tabindex="-1">列表渲染 <a class="header-anchor" href="#列表渲染" aria-label="Permalink to &quot;列表渲染&quot;">​</a></h2><p>对比vue中用v-for</p><div class="language-react vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">react</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;ul&gt;</span></span>
...
<span class="line"><span>    &lt;/div&gt;</span></span>
<span class="line"><span>  &lt;/&gt;</span></span>
<span class="line"><span>)</span></span></code></pre></div><p>如果组件不是通过函数返回实现的，而是通过 class 实现的，则需要通过 <code>this.setState</code> 方法更新。此时 <code>setState</code> 非全量更新，而是局部更新（和旧的 state 进行合并，合并第一层的属性）。</p><h3 id="一、setstate-的执行流程" tabindex="-1">一、setState 的执行流程 <a class="header-anchor" href="#一、setstate-的执行流程" aria-label="Permalink to &quot;一、setState 的执行流程&quot;">​</a></h3><ol><li><strong>调用 <code>setState</code></strong>：将更新动作放入队列。</li><li><strong>决定处理时机</strong>：根据 React 版本和场景决定是“同步”还是“异步（批处理）”。</li><li><strong>处理队列</strong>：合并更新，触发 <code>render</code>。</li></ol><h3 id="二、react-17-及以前-受控的批处理" tabindex="-1">二、React 17 及以前：受控的批处理 <a class="header-anchor" href="#二、react-17-及以前-受控的批处理" aria-label="Permalink to &quot;二、React 17 及以前：受控的批处理&quot;">​</a></h3><h4 id="_1-实现原理" tabindex="-1">1. 实现原理 <a class="header-anchor" href="#_1-实现原理" aria-label="Permalink to &quot;1. 实现原理&quot;">​</a></h4><p>React 17 的批处理本质上是通过<strong>同步代码包裹</strong>（Sync Logic Wrap）实现的。React 会在调用你的事件处理函数前，通过 <code>batchedUpdates</code> 开关将全局标志位设为 <code>true</code>。</p><ul><li><strong>同步流程</strong>：整个“收集 setState -&gt; 执行你的函数 -&gt; 触发 render”的过程都是在同一个<strong>同步宏任务</strong>中完成的。</li><li><strong>同步局限</strong>：由于它是靠同步执行流中 <code>finally</code> 块来关闭开关并触发渲染的，一旦遇到 <code>setTimeout</code> 等异步操作，这段同步逻辑早已结束。</li></ul><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// setState 核心逻辑 (React 17)</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">function</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> setState</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">newState</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) {</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">  if</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (isBatchingUpdates) {</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    updateQueue.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">push</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(newState); </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 批处理：收集更新</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">else</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    // 立即执行同步更新 + 同步 render() (导致多次渲染断点)</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 批量更新的开关 (同步包裹)</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">function</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> batchedUpdates</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">fn</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) {</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  isBatchingUpdates </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> true</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;    </span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">  try</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">    fn</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();                      </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 同步执行你的逻辑</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">finally</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    isBatchingUpdates </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> false</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">; </span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">    flushUpdateQueue</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();        </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 同步触发一次 render</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h4 id="_2-同步-vs-异步场景" tabindex="-1">2. 同步 vs 异步场景 <a class="header-anchor" href="#_2-同步-vs-异步场景" aria-label="Permalink to &quot;2. 同步 vs 异步场景&quot;">​</a></h4><ul><li><strong>异步（批量更新）</strong>：React 能接管的地方（如合成事件、生命周期）。</li><li><strong>同步（立即更新）</strong>：React 无法接管的地方（如 <code>setTimeout</code>、原生 DOM 事件）。</li></ul><p><strong>为什么 <code>setTimeout</code> 会逃脱？</strong> 当 <code>setTimeout</code> 的回调执行时，<code>batchedUpdates</code> 的 <code>finally</code> 块早已执行完毕，<code>isBatchingUpdates</code> 已被重置为 <code>false</code>，导致更新变为同步。</p><h4 id="_3-react-17-场景总结" tabindex="-1">3. React 17 场景总结 <a class="header-anchor" href="#_3-react-17-场景总结" aria-label="Permalink to &quot;3. React 17 场景总结&quot;">​</a></h4><table tabindex="0"><thead><tr><th style="text-align:left;">场景</th><th style="text-align:left;"><code>isBatchingUpdates</code></th><th style="text-align:left;">表现</th><th style="text-align:left;"><code>render</code> 次数</th></tr></thead><tbody><tr><td style="text-align:left;">合成事件（<code>onClick</code> 等）</td><td style="text-align:left;"><code>true</code></td><td style="text-align:left;">异步，批量合并</td><td style="text-align:left;">1 次</td></tr><tr><td style="text-align:left;">生命周期</td><td style="text-align:left;"><code>true</code></td><td style="text-align:left;">异步，批量合并</td><td style="text-align:left;">1 次</td></tr><tr><td style="text-align:left;"><code>setTimeout</code> / <code>setInterval</code></td><td style="text-align:left;"><code>false</code></td><td style="text-align:left;"><strong>同步，立即更新</strong></td><td style="text-align:left;">多次</td></tr><tr><td style="text-align:left;">原生 DOM 事件</td><td style="text-align:left;"><code>false</code></td><td style="text-align:left;"><strong>同步，立即更新</strong></td><td style="text-align:left;">多次</td></tr></tbody></table><h3 id="三、react-18-自动批处理-automatic-batching" tabindex="-1">三、React 18：自动批处理 (Automatic Batching) <a class="header-anchor" href="#三、react-18-自动批处理-automatic-batching" aria-label="Permalink to &quot;三、React 18：自动批处理 (Automatic Batching)&quot;">​</a></h3><h4 id="_1-实现原理-1" tabindex="-1">1. 实现原理 <a class="header-anchor" href="#_1-实现原理-1" aria-label="Permalink to &quot;1. 实现原理&quot;">​</a></h4><p>React 18 彻底抛弃了同步标志位，改为将“处理队列”动作调度到<strong>异步微任务</strong>中执行：</p><ul><li><strong>异步性</strong>：无论在何处调用 <code>setState</code>，React 都会先将更新放入队列，并触发一个微任务（Microtask）。</li><li><strong>全场景自动合并</strong>：由于微任务会在“当前宏任务（如点击事件、定时器回调）的所有同步代码跑完后”才执行，因此无论 <code>setState</code> 在哪里调用，都能实现异步合并。</li></ul><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">let</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> updateQueue </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> [];</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">let</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> isFlushScheduled </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> false</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">; </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 是否已调度过微任务</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">function</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> setState</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">newState</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) {</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  updateQueue.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">push</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(newState);  </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 永远先放入队列，不立即执行</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">  if</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">isFlushScheduled) {</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    isFlushScheduled </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> true</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    // 调度异步微任务 (核心变更：从同步变异步)</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      isFlushScheduled </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> false</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">      flushQueue</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();            </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 在这里统一处理合并，触发一次 render</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    });</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h4 id="_2-为什么微任务能自动合并" tabindex="-1">2. 为什么微任务能自动合并？ <a class="header-anchor" href="#_2-为什么微任务能自动合并" aria-label="Permalink to &quot;2. 为什么微任务能自动合并？&quot;">​</a></h4><p>微任务的特性是：<strong>同步代码全部执行完，才会执行微任务</strong>。 即便在 <code>setTimeout</code> 中，多次 <code>setState</code> 也会先放入队列，等该次宏任务的同步代码跑完后，再由微任务统一处理。</p><h4 id="_3-react-18-场景总结" tabindex="-1">3. React 18 场景总结 <a class="header-anchor" href="#_3-react-18-场景总结" aria-label="Permalink to &quot;3. React 18 场景总结&quot;">​</a></h4><table tabindex="0"><thead><tr><th style="text-align:left;">场景</th><th style="text-align:left;">表现</th><th style="text-align:left;"><code>render</code> 次数</th></tr></thead><tbody><tr><td style="text-align:left;">合成事件</td><td style="text-align:left;">批量更新</td><td style="text-align:left;">1 次</td></tr><tr><td style="text-align:left;">生命周期</td><td style="text-align:left;">批量更新</td><td style="text-align:left;">1 次</td></tr><tr><td style="text-align:left;"><code>setTimeout</code> / <code>setInterval</code></td><td style="text-align:left;"><strong>✅ 自动批量更新</strong></td><td style="text-align:left;">1 次</td></tr><tr><td style="text-align:left;">原生 DOM 事件</td><td style="text-align:left;"><strong>✅ 自动批量更新</strong></td><td style="text-align:left;">1 次</td></tr></tbody></table><h3 id="四、核心对比总结" tabindex="-1">四、核心对比总结 <a class="header-anchor" href="#四、核心对比总结" aria-label="Permalink to &quot;四、核心对比总结&quot;">​</a></h3><table tabindex="0"><thead><tr><th style="text-align:left;">特性</th><th style="text-align:left;">React 17</th><th style="text-align:left;">React 18</th></tr></thead><tbody><tr><td style="text-align:left;"><strong>控制方式</strong></td><td style="text-align:left;"><code>isBatchingUpdates</code> 标志位</td><td style="text-align:left;">微任务调度</td></tr><tr><td style="text-align:left;"><strong><code>setState</code> 本身</strong></td><td style="text-align:left;">可能同步执行</td><td style="text-align:left;"><strong>永远是异步的</strong>（放入队列）</td></tr><tr><td style="text-align:left;"><strong><code>render</code> 触发</strong></td><td style="text-align:left;">可能立即触发</td><td style="text-align:left;">永远通过微任务异步触发</td></tr><tr><td style="text-align:left;"><strong><code>setTimeout</code></strong></td><td style="text-align:left;">❌ 同步更新</td><td style="text-align:left;">✅ 自动批量更新</td></tr><tr><td style="text-align:left;"><strong>原生事件</strong></td><td style="text-align:left;">❌ 同步更新</td><td style="text-align:left;">✅ 自动批量更新</td></tr><tr><td style="text-align:left;"><strong>批处理范围</strong></td><td style="text-align:left;">仅 React 能接管的地方</td><td style="text-align:left;"><strong>全场景覆盖</strong></td></tr></tbody></table><h3 id="五、一句话总结" tabindex="-1">五、一句话总结 <a class="header-anchor" href="#五、一句话总结" aria-label="Permalink to &quot;五、一句话总结&quot;">​</a></h3><ul><li><strong>React 17</strong>：通过手动开关标志位，利用同步代码块的包裹来实现批处理，<code>setTimeout</code> 等场景因脱离包裹环境而失效。</li><li><strong>React 18</strong>：利用事件循环机制（微任务），确保无论在何处调用，都会在当前同步代码执行完后才进行合并更新。</li></ul><h3 id="六、如何脱离自动批处理" tabindex="-1">六、如何脱离自动批处理 <a class="header-anchor" href="#六、如何脱离自动批处理" aria-label="Permalink to &quot;六、如何脱离自动批处理&quot;">​</a></h3><ul><li><strong>React 17 及以前</strong>：可以使用 <code>setTimeout</code> 等异步操作包裹 <code>setState</code>。</li><li><strong>React 18</strong>：提供了 <code>flushSync</code> API 用于强制同步刷新 DOM，从而避免批处理。</li></ul><div class="language-react vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">react</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { flushSync } from &#39;react-dom&#39;;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  });</span></span>
<span class="line"><span>  // 此时 DOM 已经同步更新</span></span>
<span class="line"><span>  flushSync(() =&gt; {</span></span>
<span class="line"><span>    setFlag(f =&gt; !f);</span></span>
<span class="line"><span>  });</span></span>
<span class="line"><span>  // 此时 DOM 再次同步更新</span></span>
...
<span class="line"><span>    &lt;/&gt;</span></span>
<span class="line"><span>  )</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="forwardref-与-useimperativehandle" tabindex="-1">forwardRef 与 useImperativeHandle <a class="header-anchor" href="#forwardref-与-useimperativehandle" aria-label="Permalink to &quot;forwardRef 与 useImperativeHandle&quot;">​</a></h2><p>用于在函数组件中向父组件暴露内部 DOM 或自定义实例方法，常与 <code>forwardRef</code> 配合使用(react19以前，react19以后可以直接传入ref而不使用forwardRef)。</p><p>简单示例（<code>forwardRef</code> 转发 ref 到子组件的 DOM）：</p><div class="language-react vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">react</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 子组件通过 forwardRef 转发 ref 到内部 DOM</span></span>
...
<span class="line"><span>})</span></span></code></pre></div><h2 id="uselayouteffect" tabindex="-1">useLayoutEffect <a class="header-anchor" href="#uselayouteffect" aria-label="Permalink to &quot;useLayoutEffect&quot;">​</a></h2><p>与useEffect类似，区别在于useLayoutEffect会在DOM更新完成后立即执行（会阻塞浏览器绘制），而useEffect会在DOM更新完成后延迟执行（等浏览器空闲时）。因此，如果需要在DOM更新后立即读取布局信息或同步执行副作用，应该使用useLayoutEffect。</p><p>渲染 → DOM更新 → useLayoutEffect → 浏览器绘制 → useEffect</p><p>如果需要在使用useEffect的时候，更新了组件的状态，可能会重新渲染组件，导致页面闪烁，这时可以使用useLayoutEffect来避免这种情况，因为它会在DOM更新后立即执行，可以同步更新状态，避免不必要的重新渲染。</p><h2 id="自定义hook" tabindex="-1">自定义Hook <a class="header-anchor" href="#自定义hook" aria-label="Permalink to &quot;自定义Hook&quot;">​</a></h2><p>用来将可复用的代码包装起来</p><p>封装自定义hook的通用思路</p><ol><li>声明一个名称以use开头的函数</li><li>在函数内部封装可以复用的逻辑</li><li>将组件中用到的状态和函数return出去</li><li>在哪个组件中需要用到封装的逻辑，就通过解构，将状态和函数获得并使用</li></ol><p>hook(use*)的使用规则：</p><ul><li>只能在组件中或其他自定义Hook函数中使用</li><li>只能在组件的顶层进行调用，无法嵌套在if、for、内部函数中</li></ul><div class="language-react vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">react</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 示例</span></span>
...
<span class="line"><span>    &lt;/&gt;</span></span>
<span class="line"><span>  )</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="usememo" tabindex="-1">useMemo <a class="header-anchor" href="#usememo" aria-label="Permalink to &quot;useMemo&quot;">​</a></h2><p>计算属性，用于缓存结果，当依赖项发生变化时才会重新计算，否则会直接返回之前缓存的结果，避免不必要的计算，提高性能。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 第一个参数是计算函数，需要返回计算后的值；第二个参数则是依赖项，即当依赖项变更后再重新计算</span></span>
<span class="line"><span>useMemo(func, dependencies)</span></span></code></pre></div><h2 id="和-fragment-的区别" tabindex="-1">&lt;&gt;和&lt;Fragment&gt;的区别 <a class="header-anchor" href="#和-fragment-的区别" aria-label="Permalink to &quot;\\&lt;\\&gt;和\\&lt;Fragment\\&gt;的区别&quot;">​</a></h2><p>&lt;&gt;是&lt;Fragment&gt;的语法糖，区别在于可以在&lt;Fragment&gt;上添加key</p><h2 id="memo组件" tabindex="-1">memo组件 <a class="header-anchor" href="#memo组件" aria-label="Permalink to &quot;memo组件&quot;">​</a></h2><p>一般情况下，父组件的重新渲染会导致子组件的重新渲染，即使子组件的props没有发生变化，这时可以使用memo组件来优化性能，memo组件会对比前后props的变化（浅比较），如果没有变化则不会重新渲染子组件。</p><p>基本用法：<code>const MemoizedComponent = memo(SomeComponent, arePropsEqual?)</code>,其中<code>someComponent</code>是要包装的组件，<code>arePropsEqual</code>是一个可选的函数，用于自定义比较逻辑，默认情况下，memo会进行浅比较(Object.is)。</p><p>自定义比较逻辑： <code>memo</code> 接受第二个参数 <code>arePropsEqual(prevProps, nextProps)</code>。</p><ul><li>返回 <code>true</code>：不重新渲染（props 相等）</li><li>返回 <code>false</code>：重新渲染（props 不相等）</li><li>注意：这与 <code>shouldComponentUpdate</code> 的返回值逻辑相反。</li></ul><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> MyComponent</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> memo</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(Chart, (</span><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">prevProps</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">nextProps</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  // 可以在这里实现深比较，或者只比较特定的某些 props</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span></code></pre></div><p>两种用法：</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 1. 使用React.memo</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> memoComp</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> React.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">memo</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(({ </span><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">value</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> }) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">  return</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> &lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">div</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;{value}&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">div</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">})</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 2. 使用memo函数</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> memoComp</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> memo</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(({ </span><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">value</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> }) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">  return</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> &lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">div</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;{value}&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">div</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">})</span></span></code></pre></div><p>什么场景下使用memo组件：</p><ul><li>父组件频繁更新，但子组件的props不经常变化</li><li>子组件的渲染比较复杂，性能开销较大</li><li>子组件的props是基本类型</li><li>子组件的props是对象类型，但父组件每次更新时都会传入同一个对象（即引用地址不变）</li><li>一般来说，渲染item的组件推荐使用memo</li></ul><p>什么情况下不适合使用memo组件：</p><ul><li>父组件更新不频繁，或者子组件的渲染开销较小（比较的开销可能大于渲染开销）</li><li>子组件的props几乎总是变化（例如父组件传入了未经过 <code>useCallback</code> 或 <code>useMemo</code> 优化的引用类型数据）</li></ul><h2 id="usecallback" tabindex="-1">useCallback <a class="header-anchor" href="#usecallback" aria-label="Permalink to &quot;useCallback&quot;">​</a></h2><p><code>useCallback</code> 用于缓存函数，返回一个 memoized 版本的回调函数，该函数仅在依赖项发生变化时才会更新。它的作用是避免在组件重新渲染时创建新的函数实例，从而优化性能。</p><p>使用场景：</p><ul><li>子组件使用 <code>React.memo</code> 包裹，并且父组件传递了一个函数作为 props。使用 <code>useCallback</code> 可以确保在父组件重新渲染时，传递给子组件的函数引用保持不变，从而避免子组件不必要的重新渲染。</li><li>函数作为依赖项传入 <code>useEffect</code>、<code>useMemo</code> 或其他 <code>useCallback</code> 时，使用 <code>useCallback</code> 可以确保依赖项的稳定性，避免因函数引用变化而导致的副作用重新执行。</li></ul><h2 id="事件代理机制" tabindex="-1">事件代理机制 <a class="header-anchor" href="#事件代理机制" aria-label="Permalink to &quot;事件代理机制&quot;">​</a></h2><p>React 事件代理机制总结</p><p>核心结论</p><p>React 事件系统本质是一个增强版的事件委托，把整棵组件树的事件统一代理到 root 上，触发时再沿着 fiber 树路径分发。</p><p>一、基础机制</p><p>onClick 不是真正绑在 DOM 上的</p><p>你写的所有 onClick、onClickCapture 等 只是存在对应的 fiber 节点上 真正的监听器只有两个，绑在 root 上：  root.addEventListener(&#39;click&#39;, handleCapture, true)   // 代理所有捕获事件 root.addEventListener(&#39;click&#39;, handleBubble, false)   // 代理所有冒泡事件</p><p>触发时按路径分发</p><p>用户点击 button     ↓ 浏览器通知 root 的监听器     ↓ React 通过 nativeEvent.target 找到 button 的 fiber     ↓ 沿着 fiber.return 向上收集路径（从内到外）     [button, inner, outer, root]     ↓ 捕获阶段：反向遍历路径，依次触发 onClickCapture（从外到内） 冒泡阶段：正向遍历路径，依次触发 onClick（从内到外）</p><p>注意：浏览器捕获是从外到内的，但 React 收集路径是从 target fiber 向上收集的（从内到外），最终通过遍历方向来保证触发顺序正确。</p><p>二、捕获和冒泡的顺序</p><p>捕获和冒泡的顺序完全依赖浏览器原生机制 不是优先级队列，React 不需要额外判断：  root.addEventListener(&#39;click&#39;, handleCapture, true)   → 浏览器捕获阶段触发 → 处理 onClickCapture  root.addEventListener(&#39;click&#39;, handleBubble, false)   → 浏览器冒泡阶段触发 → 处理 onClick  浏览器原生保证捕获先于冒泡 React 只需要在对应监听器里处理对应的合成事件  // 优先级队列是 Fiber 调度的概念 // 是 setState 之后的事，和事件触发顺序完全无关</p><p>三、React 16 vs React 17</p><p>React 16（委托在 document）</p><p>事件流： document捕获 → 原生事件 → document冒泡（合成事件在这里处理）  onClick 必须等事件冒泡到 document 才触发 button 上没有任何原生监听器 所以 wrapper 在中途 stopPropagation 事件到不了 document → 合成事件完全收不到 ❌</p><p>React 17+（委托在 root）</p><p>事件流： document捕获 → root捕获(onClickCapture) → 原生捕获 → 原生冒泡 → root冒泡(onClick) → document冒泡  合成事件在 root 就处理完，不依赖冒泡到 document root 外部的 stopPropagation 不再影响合成事件 ✅ 多个 React 实例各自代理自己的 root，互不干扰 ✅</p><p>四、stopPropagation 的影响</p><p>React 16：   root 内外任何地方截断  → 合成事件失效 ❌   （合成事件依赖冒泡到 document，中途截断就完全失效）  React 17+：   root 内部截断  → 合成事件失效（符合预期）⚠️   root 外部截断  → 合成事件不受影响 ✅  不会踩坑的情况：   ✅ 全程只用 React 合成事件   ✅ 不混用原生 addEventListener   ✅ 不在原生事件里 stopPropagation   → React 16 和 17 对你完全无感知</p><p>五、完整流程</p><p>用户点击 button     ↓ 浏览器捕获（从外到内）     document → root → outer → inner → button     ↓ root 捕获监听器触发     → 从 button fiber 向上收集路径     → 反向遍历，触发所有 onClickCapture ✅     ↓ 原生捕获继续（outer → inner → button）     ↓ 浏览器冒泡（从内到外）     button → inner → outer → root     ↓ root 冒泡监听器触发     → 从 button fiber 向上收集路径     → 正向遍历，触发所有 onClick ✅     ↓ 冒泡继续到 document     ↓ onClick 里如果有 setState     → 才进入 Fiber 调度，才涉及优先级</p><p>六、一句话记忆</p><p>事件代理：  2 个监听器代理整棵树，onClick 不是真正绑在 DOM 上 收集路径：  从 target fiber 向上收集，再靠遍历方向区分捕获/冒泡 捕获冒泡：  靠浏览器原生机制区分，与优先级队列无关 React 16：  委托在 document，中途截断合成事件就失效 React 17：  委托在 root，不受外部干扰，支持微前端</p><h1 id="redux" tabindex="-1">Redux <a class="header-anchor" href="#redux" aria-label="Permalink to &quot;Redux&quot;">​</a></h1><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 1. 定义 reducer 函数 </span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  })</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">})</span></span></code></pre></div><h2 id="react-redux" tabindex="-1">React-redux <a class="header-anchor" href="#react-redux" aria-label="Permalink to &quot;React-redux&quot;">​</a></h2><p>首先需要安装@reduxjs/toolkit和redux</p><p>操作逻辑如下</p><p>注:actions.payload就是图四调用中传入的参数</p><p><img src="`+h+`" alt=""></p><p>由于Redux自身只支持同步actions的操作，如果想使用异步actions，就必须要引入redux-thunk，这是一个中间件，用于拦截actions-&gt;state，可以在内部添加复杂逻辑。</p><p>原先流程是使用时直接使用dispatch传入名称和参数，现在相当于使用一个异步函数包上这个流程，然后直接dispatch这个函数。redux-thunk会检测到返回的是函数，并自动执行它，传入 <code>dispatch</code> 和 <code>getState</code>两个函数。如果传递的是普通对象，redux-thunk不会进行额外操作。</p><p>写法如下</p><div class="language-react vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">react</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 这是一个异步的actions</span></span>
...
<span class="line"><span>const name = params.name   // 直接访问对象属性即可</span></span></code></pre></div><h2 id="嵌套路由" tabindex="-1">嵌套路由 <a class="header-anchor" href="#嵌套路由" aria-label="Permalink to &quot;嵌套路由&quot;">​</a></h2>`,163)),c("p",null,[s[0]||(s[0]=n("通过在路由中配置Children实现子路由，然后再在主路由中配置")),o(p),s[1]||(s[1]=n(",该标签会将对应的路由组件渲染到该标签内"))]),s[3]||(s[3]=a(`<div class="language-react vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">react</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 创建路由</span></span>
<span class="line"><span>const router = createBrowserRouter([</span></span>
<span class="line"><span>  {</span></span>
<span class="line"><span>    path: &quot;/&quot;,</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>\`createHashRouter\` 对应的是hash模式</span></span></code></pre></div>`,1))])}const f=t(r,[["render",d]]);export{m as __pageData,f as default};

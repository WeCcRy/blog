import{_ as t,C as i,c as e,o as l,ae as a,j as c,a as n,G as h}from"./chunks/framework.z0sZ1NT9.js";const o="/blog/assets/react-redux.CbOKGAZi.png",f=JSON.parse('{"title":"React18","description":"","frontmatter":{},"headers":[],"relativePath":"articles/frontend/React18.md","filePath":"articles/frontend/React18.md"}'),r={name:"articles/frontend/React18.md"};function d(k,s,g,u,E,y){const p=i("Outlet");return l(),e("div",null,[s[2]||(s[2]=a(`<h1 id="react18" tabindex="-1">React18 <a class="header-anchor" href="#react18" aria-label="Permalink to &quot;React18&quot;">​</a></h1><h1 id="jsx" tabindex="-1">JSX <a class="header-anchor" href="#jsx" aria-label="Permalink to &quot;JSX&quot;">​</a></h1><h2 id="响应表达式" tabindex="-1">响应表达式 <a class="header-anchor" href="#响应表达式" aria-label="Permalink to &quot;响应表达式&quot;">​</a></h2><p>通过 <code>{}</code> 识别表达式，类似vue中的双<code>{}</code></p><h2 id="列表渲染" tabindex="-1">列表渲染 <a class="header-anchor" href="#列表渲染" aria-label="Permalink to &quot;列表渲染&quot;">​</a></h2><p>对比vue中用v-for</p><div class="language-react vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">react</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;ul&gt;</span></span>
...
<span class="line"><span>const name = params.name   // 直接访问对象属性即可</span></span></code></pre></div><h2 id="嵌套路由" tabindex="-1">嵌套路由 <a class="header-anchor" href="#嵌套路由" aria-label="Permalink to &quot;嵌套路由&quot;">​</a></h2>`,153)),c("p",null,[s[0]||(s[0]=n("通过在路由中配置Children实现子路由，然后再在主路由中配置")),h(p),s[1]||(s[1]=n(",该标签会将对应的路由组件渲染到该标签内"))]),s[3]||(s[3]=a(`<div class="language-react vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">react</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 创建路由</span></span>
<span class="line"><span>const router = createBrowserRouter([</span></span>
<span class="line"><span>  {</span></span>
<span class="line"><span>    path: &quot;/&quot;,</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>\`createHashRouter\` 对应的是hash模式</span></span></code></pre></div>`,1))])}const m=t(r,[["render",d]]);export{f as __pageData,m as default};
